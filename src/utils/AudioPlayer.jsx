...
const AudioPlayer = () => {
  ...
  return (
    <div className="fixed flex justify-between items-center bottom-0 right-0 left-0 bg-[#1E3648] text-white px-3 lg:px-5 py-2 shadow-xl">
      <div className="flex space-x-5 ">
        <div className="bg-gray-900 flex justify-center items-center p-4 rounded-[50%] ">
          <BsFileEarmarkMusicFill size={25} />
        </div>
